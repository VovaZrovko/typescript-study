...
/* link: https://typescript-exercises.github.io/#exercise=11&file=%2Findex.ts
...
To implement the solution    
    Created module folder with index.js where functions are provided, index.d.ts for implementing task
*/
