/* link: https://typescript-exercises.github.io/#exercise=9&file=%2Findex.ts
Exercise:
...
// ApiResponse<number> here I was wandering should I use number or never as in callback we send an error
// due to test on site here should be a number. But another question should it be so??? 
// If we know that we pass error so we should pass ApiErrorResponse.
